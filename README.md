...
git clone으로 코드 다운을 해야 하므로 git이 동작해야 함
...
conda 가상환경 생성시 torch를 포함한 다양한 패키지 설치를 하기 때문에 꽤 오랜 시간이 걸립니다<br>
...
https://drive.google.com/file/d/138_4vDAVEY5XTMqmcmR56WlSflOq6Zpv/view?usp=drive_link <br>
